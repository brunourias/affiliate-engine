...
const creative={id:'cr1',campaignId:'cp1',experimentId:null,name:'Criativo',status:'DRAFT',contentType:'SHORT_VIDEO',targetChannel:'GENERIC',angleTypeSnapshot:null,objectiveSnapshot:'EDUCATION',editorialVerdictSnapshot:'WORTH_IT',priceVerdictSnapshot:'FAIR_PRICE',title:'Título inicial',contentPremise:null,hook:null,bodyScript:null,cta:null,estimatedDurationSeconds:20,disclosureText:'Afiliado',requiredWarnings:[],forbiddenClaims:[],generationMode:'MANUAL',variantGroup:null,parentCreativeId:null,variantLabel:null};
