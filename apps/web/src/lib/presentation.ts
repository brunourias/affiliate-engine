const LABELS: Record<string, string> = {
  ...
  COST_BENEFIT: 'Custo-benefício', BEGINNER_FRIENDLY: 'Para iniciantes', HOME_USE: 'Uso doméstico', CONVENIENCE: 'Conveniência', WARNING_BEFORE_BUYING: 'Atenção antes da compra', UNDERRATED: 'Pouco valorizado', USE_CASE: 'Caso de uso',
  CHECK_PRICE: 'Conferir preço', CHECK_DETAILS: 'Conferir detalhes', COMPARE: 'Comparar', SEE_OFFER: 'Ver oferta', SEE_IF_IT_FITS: 'Ver se faz sentido',
...
const ACTION_LABELS: Record<string, string> = {
  ...
  TIKTOK_FIRST_VARIANT_CREATED: 'Versão TikTok-first criada',
