...
class PublicationPackageCreate(BaseModel):
    distributionMode:Literal["ORGANIC","PAID_AD","UNKNOWN"]="PAID_AD";format:Literal["STATIC_CARD","CAROUSEL","VIDEO_SHORT"]="CAROUSEL";channel:str|None=None;audioPlan:AudioPlanInput=AudioPlanInput();disclosurePlan:DisclosurePlanInput=DisclosurePlanInput();trackingPlan:TrackingPlanInput=TrackingPlanInput()
